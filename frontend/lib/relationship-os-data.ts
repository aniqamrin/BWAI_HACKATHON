...
export const relationshipOsSnapshot: EcosystemSnapshot = {
  ...
  actors: [
    {
      ...
      summary: "Needs sharper enterprise buying motion after three pilot conversations stalled in procurement.",
  ...
  evidenceSources: [
    ...
    },
    {
      ...
      detail: "Warm introduction context from program staff, ecosystem partners, and sponsor office hours.",
      state: "Ready",
    },
  ],
  lenses: [
    ...
    },
    {
      ...
      description: "Rank mentors by fit, evidence coverage, current load, and likely next useful introduction.",
  ...
  signals: [
    {
      ...
      detail: "The model classifies this as buyer-risk friction, not mentor inactivity.",
      state: "Extracted",
    },
    {
      ...
      detail: "The uploaded row contains grant urgency, evidence gaps, and follow-up language for the finance sprint.",
      state: "Linked",
    },
    {
      ...
      detail: "The chat-style evidence says the hospital introduction should wait until absolute claims are softened.",
      state: "Flagged",
    },
    {
  ...
  relationships: [
    ...
    },
    {
      ...
      reasoning:
        "The fit is strong, but the recommendation still needs human review because the clinical compliance language should be checked before the next introduction.",
  ...
  actions: [
    ...
    },
    {
      ...
      summary: "The fit is good, but the AI should not send a clinical introduction without advisor review.",
      aiReasoning:
    ...
    },
    {
      ...
      aiReasoning:
        "Priya should be prioritized because Atlas has a specific blocker, the mentor has the right pattern experience, and the relationship already shows positive confidence from both sides.",
    ...
    },
    {
      ...
      relationshipId: "rel-carbonloop-farah",
      summary: "Partner fit is strong, but the operator should request one more piece of evidence before making a warm introduction.",
      aiReasoning:
        "The partner signal is promising, but GreenBridge will likely ask for warehouse pilot economics. The system should request that missing evidence before sending the introduction.",
