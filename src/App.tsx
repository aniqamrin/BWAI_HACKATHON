...
export default function App() {
  const { phase, relationships, evaluation, steps, errorMessage, processRows, failWithMessage, resetDemo } =
    useCohortDemo();
        ...
        <aside className="space-y-5 p-6">
          ...
          {evaluation ? (
            <section className="border border-[#9d8f77] bg-[#fffaf0] p-5">
              ...
              <p className="mt-3 text-lg leading-7 text-[#314036]">{evaluation.executiveSummary}</p>
            </section>
          ) : null}
        </aside>
      </div>
