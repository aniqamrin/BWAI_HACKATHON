...
export function DashboardHeader({
  ...
  return (
    <header className="grid grid-cols-[1fr_auto] gap-8 border-b border-[#17211c] px-8 py-7">
      <div>
        <p className="ui-sans text-xs font-semibold uppercase tracking-[0.16em] text-[#657064]">
          {cohortPeriod}
        </p>
        <div className="mt-3 flex items-end gap-5">
          <h1 className="text-6xl font-semibold leading-none tracking-normal text-[#17211c]">Cohort Atlas</h1>
          <span className="ui-sans mb-2 border border-[#9d8f77] px-2 py-1 text-xs font-semibold uppercase tracking-[0.12em] text-[#5d4d35]">
            Executive review
          </span>
        </div>
        <p className="mt-4 max-w-3xl text-2xl leading-snug text-[#314036]">
